(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define(["vue-router", ], factory);
	else if(typeof exports === 'object')
		exports["VueRouteKey"] = factory(require("vue-router"), require("vue"));
	else
		root["VueRouteKey"] = factory(root["vue-router"], root["Vue"]);
...
// CONCATENATED MODULE: ./src/utils/routerHookUtil.js
 ...
 * @param index
 */
function getToComponent(_x) {
  return _getToComponent.apply(this, arguments);
}
/**
 * 컴포넌트 정의에서 특정 값을 찾음
 * extends를 쫒아가며 찾음
...
function _getToComponent() {
  _getToComponent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(to) {
    var index,
        toComponent,
        _args = arguments;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            toComponent = to.matched[index].components.default;
          ...
          case 7:
            toComponent = _context.sent.default;

          case 8:
            return _context.abrupt("return", toComponent);
...
function getComponentOption(component, key) {
  if (component[key]) {
...
// CONCATENATED MODULE: ./src/mixins/routeKeyMixin.js
...
/* harmony default export */ var routeKeyMixin = ({
  computed: {
    $routeKey: {
      get: function get() {
...
// CONCATENATED MODULE: ./src/router/routeKeyHook.js
...
/* harmony default export */ var routeKeyHook = (function (to, from, next) {
  var promises = [];
  to.matched.forEach(function (m, index) {
    var promise = getToComponent(to, index).then(function (component) {
      var routeKey = "".concat(m.name);
      var routeKeyOptions = getComponentOption(component, 'routeKey');

      if (routeKeyOptions) {
        routeKeyOptions.forEach(function (key) {
          var _to$type;

          var splitKey = key.split('.');
          var type = splitKey[0];
          var name = splitKey[1];
          routeKey += "_".concat((_to$type = to[type]) === null || _to$type === void 0 ? void 0 : _to$type[name]);
        });
      }
...
//# sourceMappingURL=VueRouteKey.umd.js.map